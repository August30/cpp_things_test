...
int main() {
    ...
    // Fraction1 f1(3, 5);
    // Fraction1 f2 = f1 + 3; // 不会将3转换为(3,1)   不会隐式转换    error: no match for ‘operator+’ (operand types are ‘Fraction1’ and ‘int’)
    // f2.getNumAndDen();
    P p1 = {77, 5};
    P p2 = {77, 5, 89};
    // P p3 = {77, 5, 89, 99}; // error :copy-list-initialization cannot use a constructor marked 'explicit'
